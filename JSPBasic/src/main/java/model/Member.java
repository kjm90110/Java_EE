 ...
 * 6. 직렬화 하기 위해 Serializable 인터페이스를 구현하고 serialVersionUID를 생성(선택)
 * 
 * Javabeans = vo = pojo(plane old java object)
 * */

public class Member implements Serializable {

	private static final long serializableUID = 3958049682L;

	private String mid; // 회원 아이디
	private String mpass; // 회원 비번
	private String mname; // 회원 이름
	private int mage; // 회원 나이
	private String mcp; // 회원 폰 번호
